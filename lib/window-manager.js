...
export class WindowManager {
    ...
    constructor(options = {}) {
        ...
        this._monitor = new ShellWindowMonitor(
            (winid, eventType, details) => this._session.onWindowModified(winid, eventType, details),
            (winid, details) => this._session.getTracker().getStartupStatus(winid, details),
        )
    }
